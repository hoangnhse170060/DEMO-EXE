          ...
          <div className={`relative flex flex-col md:flex-row ${alignWrapper} pointer-events-auto`}>
            <div className={`relative w-full max-w-xl pl-16 md:pl-0 ${cardOffset} pointer-events-auto`}>
              ...
              <button
                ...
                className={`relative z-40 pointer-events-auto w-full rounded-2xl border bg-white px-5 py-4 text-left shadow-sm transition focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue ${
                  isActive
                    ? 'border-brand-blue bg-brand-blue/10 shadow-md'
                    : locked
                    ? 'border-slate-200 bg-slate-100 text-slate-500 hover:border-slate-200'
                    : 'border-brand-blue/20 hover:border-brand-blue/60 hover:shadow-md'
                }`}
              ...
              {variant === 'interactive' && (
                <button
                  ...
                  className={`mt-3 w-full rounded-full px-4 py-2 text-sm font-semibold transition ${
                    locked ? 'bg-slate-300 text-slate-600 cursor-not-allowed' : 'bg-brand-blue text-white hover:bg-brand-blue/90'
                  }`}
                  aria-disabled={locked}
                >
                  Xem Chi Tiết
